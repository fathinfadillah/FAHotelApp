...
namespace FAHotelApp.Forms
{
	public partial class FormEmailManager : Form
	{
		...
		private void StartReceiving()
		{
			Task.Run(() =>
			{
				using (ImapClient client = new ImapClient("imap.gmail.com", 993, "fahotel.management@gmail.com",
					"Fahotel@2021", AuthMethod.Login, true))
				{
		...
		{
			MessageBox.Show("Email baru telah diterima!");
			MailMessage m = e.Client.GetMessage(e.MessageUID, FetchOptions.Normal);
			f.Invoke((MethodInvoker)delegate
			{
				f.rtxtReceive.AppendText("Dari: " + m.From + "\n" +
										"Subjek: " + m.Subject + "\n" +
										"Isi: " + m.Body + "\n");
			});
		}
