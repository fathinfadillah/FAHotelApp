namespace FAHotelApp.Forms
{
	partial class FormBill
	{
		...
		private void InitializeComponent()
		{
			...
			this.billTableAdapter = new FAHotelApp.DataSet.FAHotelDataSetTableAdapters.BillTableAdapter();
			...
			this.label1.Text = "Report Tagihan";
			// 
			// bunifuSeparator1
			// 
			...
			this.btnViewReport.TabIndex = 77;
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "FAHotelApp.Report.ReportBill.rdlc";
			...
			this.billBindingSource.DataSource = this.fAHotelDataSet;
			// 
			// billTableAdapter
			// 
		...
		private DataSet.FAHotelDataSetTableAdapters.BillTableAdapter billTableAdapter;
	}
}